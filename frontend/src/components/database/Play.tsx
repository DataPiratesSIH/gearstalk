...
const CamDisplay: React.FC<CamDisplayProps> = ({ location, camera, setCamera }) => {
...
const Play: React.FC = () => {
    ...
    const optionHandler: ((event: React.MouseEvent<HTMLDivElement, MouseEvent>) => void) | undefined = (event) => {
        if (!video) {
        ...
        <React.Fragment>
                    ...
                    {Object.keys(video).length > 0 && (
                        <React.Fragment>
                            ...
                            <Grid className={classes.mainContent} container>
                                <Grid id="back" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                    <KeyboardBackspaceIcon fontSize='large' />
                                    <Typography className={classes.optionTitle}>
                                        Back to Library
                                    </Typography>
                                </Grid>
                                <Grid id="track" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                    <TrendingDownIcon fontSize='large' />
                                    <Typography className={classes.optionTitle}>
                                        Realtime Tracking
                                    </Typography>
                                </Grid>
                                <Grid id="analytics" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                ...
                                {video.processed ? (
                                    <Grid id="search" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                    ...
                                    <Grid id="process" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                ...
                                <Grid id="enhance" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
                                    <CameraEnhanceIcon fontSize='large' />
                                    <Typography className={classes.optionTitle}>
                                        Enhance Video
                                    </Typography>
                                </Grid>
                                <Grid id="bookmark" className={classes.mainOption} item md={2} sm={2} xs={6} onClick={optionHandler}>
            ...
            <Grid item md={4} xs={12}>
                <Grid container>
                    ...
                    <Grid id="time" className={classes.option} item xs={3} onClick={optionHandler}>
                        <EditIcon />
                        <Typography className={classes.optionTitle}>
                            Edit Timestamp
                        </Typography>
                    </Grid>
                    <Grid id="locate" className={classes.option} item xs={3} onClick={optionHandler}>
                        <MyLocationIcon />
                        <Typography className={classes.optionTitle}>
                            Locate Camera
                        </Typography>
                    </Grid>
                    <Grid id="edit" className={classes.option} item xs={3} onClick={optionHandler}>
                        <EditLocationIcon />
                        <Typography className={classes.optionTitle}>
                            Edit Location
                        </Typography>
                    </Grid>
                    <Grid id="delete" className={classes.option} item xs={3} onClick={optionHandler}>
                        <ClearIcon />
                        <Typography className={classes.optionTitle}>
                            Delete Video
                        </Typography>
